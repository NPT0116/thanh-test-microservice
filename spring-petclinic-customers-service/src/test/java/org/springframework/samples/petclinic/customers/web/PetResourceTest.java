...
class PetResourceTest {
    ...
    private Pet setupPet() throws Exception {
        ...
        // Giả sử Owner có setter cho firstName, lastName (chỉ dùng cho test)
        owner.setFirstName("George");
        owner.setLastName("Bush");

        Pet pet = new Pet();
        // Với test, giả sử chúng ta có setter cho id (nếu không thì có thể dùng ReflectionTestUtils)
        pet.setId(2);
        pet.setName("Basil");
    ...
    void shouldUpdatePetSuccessWithPetTypeFound() throws Exception {
        Date birthDate = new SimpleDateFormat("yyyy-MM-dd").parse("2021-05-05");
        PetRequest petRequest = new PetRequest(200, birthDate, "Max", 20);

        Pet existingPet = new Pet();
        existingPet.setName("OldMax");
        existingPet.setBirthDate(new SimpleDateFormat("yyyy-MM-dd").parse("2020-01-01"));
        ...
        // Sau khi cập nhật, pet sẽ được lưu lại với tên, ngày sinh và pet type mới
    ...
    void shouldUpdatePetSuccessWithoutPetType() throws Exception {
        Date birthDate = new SimpleDateFormat("yyyy-MM-dd").parse("2021-06-06");
        PetRequest petRequest = new PetRequest(300, birthDate, "Bella", 30);

        Pet existingPet = new Pet();
        existingPet.setName("OldBella");
        existingPet.setBirthDate(new SimpleDateFormat("yyyy-MM-dd").parse("2020-02-02"));
    ...
    void shouldFailUpdatePetWhenNotFound() throws Exception {
        Date birthDate = new SimpleDateFormat("yyyy-MM-dd").parse("2021-07-07");
